...
namespace {
    ...
    void ReadCSV(std::string const &file) {
        ...
        rapidcsv::Document const doc(csv_stream, rapidcsv::LabelParams(settings::GetSettings()->header_line_idx, -1), rapidcsv::SeparatorParams(settings::GetSettings()->separator[0]));
